...
if __name__=="__main__":
    ...
    for i in range(num_iterations):
        ...
        ax_client.generation_strategy.trials_as_df.to_csv("meta_training_failures_175_sem.csv")
        try:
            best_parameters, values = ax_client.get_best_parameters()
            best_parameter_list.append(best_parameters)
            pd.DataFrame.from_records(best_parameter_list).to_csv("meta_training_failures_175_sem_best_parameters.csv")
