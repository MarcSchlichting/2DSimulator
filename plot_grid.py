...
mean_rk4,std_rk4 = model_rk4(torch.Tensor(points.T))
mean_rk4 = mean_rk4.reshape(20,20)
std_rk4 = std_rk4.reshape(20,20)

kernel_rk2 = RBF(0.001)
...
mean_rk2,std_rk2 = model_rk2(torch.Tensor(points.T))
mean_rk2 = mean_rk2.reshape(20,20)
std_rk2 = std_rk2.reshape(20,20)

kernel_rk1 = RBF(0.001)
...
mean_rk1,std_rk1 = model_rk1(torch.Tensor(points.T))
mean_rk1 = mean_rk1.reshape(20,20)
std_rk1 = std_rk1.reshape(20,20)



fig,axs = plt.subplots(3,3,figsize=(15,10))
axs[0,0].imshow(np.mean(rk4_data,axis=-1),vmin=0,vmax=600,extent=[0,2,0.1,1.5],origin="lower")
...
axs[0,1].imshow(np.mean(rk2_data,axis=-1),vmin=0,vmax=600,extent=[0,2,0.1,1.5],origin="lower")
...
axs[0,2].imshow(np.mean(rk1_data,axis=-1),vmin=0,vmax=600,extent=[0,2,0.1,1.5],origin="lower")
...
axs[1,0].imshow(mean_rk4,vmin=0,vmax=600,extent=[0,2,0.1,1.5],origin="lower")
...
axs[1,1].imshow(mean_rk2,vmin=0,vmax=600,extent=[0,2,0.1,1.5],origin="lower")
...
axs[1,2].imshow(mean_rk1,vmin=0,vmax=600,extent=[0,2,0.1,1.5],origin="lower")
