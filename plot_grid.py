...
axs[0,0].imshow(np.mean(rk4_data,axis=-1),vmin=0,vmax=500,extent=[0,2,0.1,1.5],origin="lower",aspect="auto")
axs[0,0].contour(S_STD,DT,cost_rk4,levels=[500],cmap="autumn",linestyles="solid")
axs[0,0].contour(S_STD,DT,cost_rk4,levels=[200],cmap="autumn",linestyles="dashdot")
axs[0,0].contour(S_STD,DT,cost_rk4,levels=[100],cmap="autumn",linestyles="dashed")
axs[0,0].set_title("RK4 - Data")
axs[0,1].imshow(np.mean(rk2_data,axis=-1),vmin=0,vmax=500,extent=[0,2,0.1,1.5],origin="lower",aspect="auto")
axs[0,1].contour(S_STD,DT,cost_rk2,levels=[500],cmap="autumn",linestyles="solid")
axs[0,1].contour(S_STD,DT,cost_rk2,levels=[200],cmap="autumn",linestyles="dashdot")
axs[0,1].contour(S_STD,DT,cost_rk2,levels=[100],cmap="autumn",linestyles="dashed")
axs[0,1].set_title("RK2 - Data")
axs[0,2].imshow(np.mean(rk1_data,axis=-1),vmin=0,vmax=500,extent=[0,2,0.1,1.5],origin="lower",aspect="auto")
axs[0,2].contour(S_STD,DT,cost_rk1,levels=[500],cmap="autumn",linestyles="solid")
axs[0,2].contour(S_STD,DT,cost_rk1,levels=[200],cmap="autumn",linestyles="dashdot")
...
axs[1,0].contour(S_STD,DT,cost_rk4,levels=[500],cmap="autumn",linestyles="solid")
axs[1,0].contour(S_STD,DT,cost_rk4,levels=[200],cmap="autumn",linestyles="dashdot")
...
axs[1,1].contour(S_STD,DT,cost_rk2,levels=[500],cmap="autumn",linestyles="solid")
axs[1,1].contour(S_STD,DT,cost_rk2,levels=[200],cmap="autumn",linestyles="dashdot")
...
axs[1,2].contour(S_STD,DT,cost_rk1,levels=[500],cmap="autumn",linestyles="solid")
axs[1,2].contour(S_STD,DT,cost_rk1,levels=[200],cmap="autumn",linestyles="dashdot")
...
axs[2,0].contour(S_STD,DT,cost_rk4,levels=[500],cmap="autumn",linestyles="solid")
axs[2,0].contour(S_STD,DT,cost_rk4,levels=[200],cmap="autumn",linestyles="dashdot")
...
axs[2,1].contour(S_STD,DT,cost_rk2,levels=[500],cmap="autumn",linestyles="solid")
axs[2,1].contour(S_STD,DT,cost_rk2,levels=[200],cmap="autumn",linestyles="dashdot")
...
axs[2,2].contour(S_STD,DT,cost_rk1,levels=[500],cmap="autumn",linestyles="solid")
axs[2,2].contour(S_STD,DT,cost_rk1,levels=[200],cmap="autumn",linestyles="dashdot")
...
fig.tight_layout()
fig.show()
fig.savefig("grid_50.png",dpi=600)
